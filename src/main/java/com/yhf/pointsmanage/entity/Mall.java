...
public class Mall {
    ...
    private String points_impl;//积分接口地址
    private String attribution_impl;//个人信息接口地址

    public Mall() {
    }

    public Mall(int id, String name, String props, String shop_impl, String consume_impl, String logistics_impl, String order_impl, String points_impl, String attribution_impl) {
        this.id = id;
        this.name = name;
        this.props = props;
